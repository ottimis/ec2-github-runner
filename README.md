...
Run the job on it.
Finally, you can stop it when you finish or wait for it to be automatically stopped after a period of inactivity.
...
| `github-runner-group`                                                                                                                                                         | Optional. Used only with the `start` mode. | Name of the runner group. <br><br> The runner will be added to the group with this name.                                                                                                                                                                                                                                                                                                                                                                       |
